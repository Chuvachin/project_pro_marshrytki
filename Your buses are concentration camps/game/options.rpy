...
define config.name = _("Your buses are concentration camps")
...
define build.name = "Yourbusesareconcentrationcamps"
...
define config.save_directory = "Yourbusesareconcentrationcamps-1734267675"
